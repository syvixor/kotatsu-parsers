...
internal abstract class IkenParser(
    ...
    protected open val selectPages = ".comic-images-wrapper img"
    ...
    override suspend fun getPages(chapter: MangaChapter): List<MangaPage> {
        ...
        val images = doc.select(selectPages).mapNotNull {
            it.attr("src")
        ...
        if (images.isEmpty()) {
            throw Exception("No images found. Site structure may have changed.")
        }
